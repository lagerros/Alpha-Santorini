# Created by https://stackoverflow.com/users/2628369/kilian-batzner
...
def rename(checkpoint_dir, replace_from, replace_to, add_prefix, dry_run): #'''ADD save_dir = checkpoint_dir'''
